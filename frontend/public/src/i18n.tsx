...
const dict: Record<Lang, Record<string, string>> = {
  it: {
    ...
    step2_d: "Un codice di 16 cifre, generato sul tuo dispositivo: è l'unica chiave per rientrare. Conservalo.",
  ...
  en: {
    ...
    step2_t: "Get a code",
    step2_d: "A 16-digit code, generated on your device: it is the only key to return. Keep it safe.",
